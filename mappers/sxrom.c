...
u8 sxrom_read(struct nes *nes, u16 addr)
{
    switch (addr >> 13)
    {
    case 3:
...
void sxrom_write(struct nes *nes, u16 addr, u8 value)
{
...
void sxrom_init(struct nes *nes)
{
    ...
    nes->mapper.mapper_read = &sxrom_read;
    nes->mapper.mapper_write = &sxrom_write;
}
